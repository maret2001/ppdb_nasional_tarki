                            ...
                            <div class="form-area login-form">
                                <div class="form-content">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="C:\xampp\htdocs\PPDB-2024\page source ppdb bkl\Bengkulu\register.html" class="register"><span>Register</span></a></li>
                                    </ul>
                                </div>
                                <div class="form-input">
                                    <form action="{{ route('login') }}" method="post">
                                        ...
                                        <div class="myform-button">
                                            <button class="myform-btn" type="submit"><span>Login</span></button>
                                        </div>
                                        <div class="myform-button1">
                                            <button class="myform-btn1"><span>Login dengan Google</span></button>
                                        </div>
